...
module List
  ...
  attach_function :destroy_double_linked_list_with_types, [List.by_ref], :void
  ...
  attach_function :cast_half_edge, [:pointer], HalfEdge::HalfEdge.by_ref
  attach_function :cast_point, [:pointer], Points::Point.by_ref
