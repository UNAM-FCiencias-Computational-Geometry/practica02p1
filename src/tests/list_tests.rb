  ...
  class TestList
    ...
    def self.more_pop
      ...
      items.times.each do
        |item|
        if ([true,false].sample)
          point = List.cast_point(List.pop_front(list))
          Points.destroy_point(point)
        else
          point = List.cast_point(List.pop_back(list))
          Points.destroy_point(point)
        end 
      end
    ...
    def self.more_push
      ...
      point_copy = List.cast_point(List.pop_front(list))
      ...
      point_copy = List.cast_point(List.pop_back(list))
    ...
    def self.pick
      ...
      point_copy = List.cast_point(List.pick_front(list))
      result = point_copy.pointer == point.pointer ? true : false
      ...
      point_copy = List.cast_point(List.pick_back(list))
      result = point_copy.pointer == point.pointer ? result : false
